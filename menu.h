...
int firstXtoCentralizeText(int text_length, int letter_interval) {
...
void showMainMenu() {
    ...
    int title_first_x = firstXtoCentralizeText(TITLE_LENGTH, LETTER_INTERVAL);
    int title_y = 40;
	...
	int start_first_x = firstXtoCentralizeText(START_LENGTH, LETTER_INTERVAL);
    int start_y = 100;
...
void showEndingScreen(int isWin) {
    ...
    int ending_first_x = firstXtoCentralizeText(ENDING_LENGTH, LETTER_INTERVAL);
    int ending_y = 20;
    if (isWin) {
