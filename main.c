...
int main(void)
{
    // Set Mode 2 (not applicable anymore, use default Mode 0 instead since we not doing background)
    *(unsigned short *) 0x4000000 = 0x40 | 0x0 | 0x1000;
    ...
    REG_TM0D = 65535 - 328;													// set timer initial value
